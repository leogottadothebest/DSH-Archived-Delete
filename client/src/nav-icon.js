/**
 * dsh-plugin-archived-conversations — settings nav icon swap.
 *
 ...
 * gear. This module swaps the gear for the archive glyph on the nav row
 * whose label matches this plugin's section label.
 *
