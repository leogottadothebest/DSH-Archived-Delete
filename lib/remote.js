...
export class ArchivedSessionsRemote extends TypertRemoteService {
   ...
   * plugin's own endpoints) gets stamped with the current time. Entries
   * archived before this service started keep no record — the UI renders
   * them as unknown instead of backfilling a misleading date.
   */
  async [Service.init]() {
